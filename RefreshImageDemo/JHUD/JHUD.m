...
-(void)configureBaseInfo
{
    ...
    self.indicatorViewSize = CGSizeMake(50, 50);
}
...
{
    [self showAtView:view message:message hudType:JHUDLoadingTypeCircle userInteractionEnabled:NO];
}

+(void)showAtView:(UIView *)view message:(NSString *)message hudType:(JHUDLoadingType)hudType userInteractionEnabled:(BOOL)userInteractionEnabled
{
...
-(void)customAnimation{
    ...
    self.customAnimationImages = images;
}
...
-(UILabel *)messageLabel
{
    ...
    self.messageLabel.textColor = RGB(54, 201, 119);
...
-(void)updateConstraints
{
    ...
    [self addConstraintCenterXToView:self.messageLabel centerYToView:nil];
